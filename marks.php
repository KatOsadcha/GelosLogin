...
<body>
    ...
    <main>
        ...
        <?php 
        if(isset($_GET['error'])) {
            echo "<p style='color: red; font-size: 14px;'>Your marks cannot be less that 0 or more that 100. <br> Please try again!</p>";
        }
        ?>
        ...
        <form action="marks_process.php" method="post">
            <div>
                ...
                <input type="text" id="mark1" name="mark1" require>
            </div>
            <div>
                <label for="mark2">Mark 2:</label>
                <input type="text" id="mark2" name="mark2" require>
            </div>
            <div>
                <label for="mark3">Mark 3:</label>
                <input type="text" id="mark3" name="mark3" require>
            </div>
            <div>
                <label for="mark4">Mark 4:</label>
                <input type="text" id="mark4" name="mark4" require>
            </div>
            <div>
                <label for="mark5">Mark 5:</label>
                <input type="text" id="mark5" name="mark5" require>
            </div>
            <div>
